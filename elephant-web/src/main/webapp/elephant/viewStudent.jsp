...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/elephant/viewStudent.js" type="text/javascript"></script>
<script type="text/javascript">
	$(function () {
		studentView.setPath("<%=request.getContextPath() %>");
		studentView.init("<%=request.getParameter("id")%>");
	});
</script>